                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Incomes <span class="table-project-n">Data</span> Table</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="userName" data-editable="true">Income Date</th>
                                        ...
                                        <tbody>
                                            <?php foreach($result as $object):?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $object->incomeDate;?></td>
                                                    <?php if($this->session->userdata('user_type') == 'admin'):?>
                                                        <td>
                                                            <a href="<?php echo base_url();?>forms/income/edit/<?php echo $object->id;?>"><i class="fa fa-pencil-square-o btn btn-success pd-setting-ed" aria-hidden="true"></i></a> /
                                                            <a href="<?php echo base_url();?>forms/income/delete/?id=<?php echo $object->id;?>"> <i style='color:white'class="fa fa-trash pd-setting-ed btn btn-danger" aria-hidden="true"></i></a>
                                                        </td>
                                                    <?php endif;?>
                                                </tr> 
                                            <?php endforeach;?>
