  ...
  <form action="search" method="post">
   <div class="sparkline16-list responsive-mg-b-30" >
            ...
            <div class='col-sm-7'>
                ...
                foreach ($incomes as $object):?>
                   <?php $totalIncome+=$object->amount;?> 
                <?php endforeach;?>
                <p>Total Income : <?php echo $totalIncome;?></p> 
                <?php
                //calculate total expences...
                foreach ($expences as $expence):?>
                   <?php $totalExpences+=$expence->amount;?> 
                <?php endforeach;?>
                <p>Total Expences : <?php echo $totalExpences;?></p> 
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Outcomes <span class="table-project-n">Data</span> Table</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="userName" data-editable="true">OutCome Date</th>
                                        ...
                                        <tbody>
                                            <?php foreach($result as $object):?>
                                                <tr>
                                                    <td><?php echo $object->idoutcomes ;?></td>
                                                    <td><?php echo $object->description;?></td>
                                                    <td><?php echo $object->outcomeAmount;?></td>
                                                    <td><?php echo $object->outcomeDate;?></td>
                                                    <?php if($this->session->userdata('user_type') == 'admin'):?>
                                                        <td>
                                                            <a href="<?php echo base_url();?>forms/outcome/edit/<?php echo $object->idoutcomes;?>"><i class="fa fa-pencil-square-o btn btn-success pd-setting-ed" aria-hidden="true"></i></a> /
                                                        <a  href="<?php echo base_url();?>forms/outcome/delete/<?php echo $object->idoutcomes;?>"> <i class=" fa fa-trash pd-setting-ed btn btn-danger" aria-hidden="true"></i></a>
                                                        </td>
                                                    <?php endif;?>
                                                </tr> 
                                            <?php endforeach;?>
