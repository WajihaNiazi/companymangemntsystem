                        ...
                        <div class="sparkline12-list">
                            <div class="sparkline12-hd">
                                <div class="main-sparkline12-hd">
                                    <h1 style="text-align: center;">Update Outcome</h1>
                                </div>
                            </div>
                                ...
                                <div class="basic-login-form-ad">
                                    <div class="row">
                                        ...
                                        <div class="all-form-element-inner">
                                                ...
                                                <?php echo form_open('forms/outcome/edit/'.$outcome->idoutcomes.'',$attributes);?>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="login-btn-inner">
                                                            <div class="row">
                                                                ...
                                                                <a style="font-weight: bold;background-color:black;border-color:black;color:white" href="<?php echo base_url();?>forms/outcome/outcome_report" class='btn btn-primary login-submit-cs'>Cancel</a>
