                        ...
                        <div class="sparkline12-list">
                            <div class="sparkline12-hd">
                                <div class="main-sparkline12-hd">
                                    <h1 style="text-align: center;">Update Income</h1>
                                </div>
                            </div>
                                ...
                                <div class="basic-login-form-ad">
                                    <div class="row">
                                        ...
                                        <div class="all-form-element-inner">
                                                ...
                                                <?php echo form_open('forms/income/edit/'.$income->id.'',$attributes);?>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        ...
                                                                        <a href="<?php echo base_url();?>forms/income/income_report" style="font-weight: bold;background-color:black;border-color:black;color:white" class='btn btn-primary login-submit-cs'>Cancel</a>
